                    ...
                    <div id="boderRight">
                        <table class="tblRpt " width="700" style="display:none" border="0" cellpadding="0" cellspacing="1" id="tbl-rpt">
							...
							<?php 
								...
								$totalU = $user->getTotalOutStanding();
								$totalOut += $totalU;
                            ...
                            <tr bgcolor="#F6F8F9" onmouseover="this.style.backgroundColor='#f8ff8d'" onmouseout="this.style.backgroundColor='#F6F8F9'">
                                ...
                                <td><span class="downline_link" onclick="viewSBBetList('<?php echo $user->Id ?>','<?php echo $user->Username ?>','<?php echo $user->role ?>')"><?php echo number_format($totalU,2); ?></span>
                                </td>
                                <td></td>
                                <td></td>
                                <td><span class="downline_link" onclick="viewBingoOutstandingBetList('<?php echo $user->Id ?>','<?php echo $user->Username ?>','RunByDate_Mem',2)"></span>
                                </td>
                                <td></td>
                                <td><span class="downline_link" onclick="viewCasinoOutstandingBetList('<?php echo $user->Id ?>','<?php echo $user->Username ?>','RunByDate_Mem',2)"></span>
                                </td>
                                <td></td>
                                <td><span></span>
                                </td>
