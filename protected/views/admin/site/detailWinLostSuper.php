                                        ...
                                        <div id="spDateTimeSearch">
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr style="height: 32px;">
                                                    ...
                                                    <td id="tdToDateCal" class="l"><span id="spToDateCal"><table cellpading="0" cellspacing="0" border="0"><tr><td><input id="tdate" class="date_no" value="<?php echo date('m/d/Y'); ?>" type="text" size="13"name="tdate" readonly="readonly" /></td><td><input type="image" alt="" src="/assets/_GlobalResources/Images/cal.gif" id="tdate_trigger" title="Date selector"style="margin: 0px; cursor: pointer" onclick="javascript:return false;" /><!-- <img alt="" src="/_GlobalResources/Images/cal.gif" id="tdate_trigger" title="Date selector"style="margin: 0px; cursor: pointer" /> --></td></tr></table><script type="text/javascript">function CalendarOnSelect() {if($("ddlSelectDate"))$("ddlSelectDate").value = 8;}var tdate = Calendar.setup({animation:false,trigger: "tdate_trigger",inputField: "tdate",min: 20140901,max: 99991231,dateFormat: "%m/%d/%Y",weekNumbers:true,onSelect: function() {CalendarOnSelect();this.hide();}});</script></span>
                                                    </td>
                                                    <td class="l">&nbsp;&nbsp;
                            ...
                            <div id="boderRight">
                                <table class="tblRpt " width="100%" style="min-width:800px; display:none" border="0" cellpadding="0" cellspacing="1" id="tbl-rpt">
									...
									<?php 
											...
											$totalGross += number_format($userCom,2);
											$totalEarn += ($totalGross + $dataAll);
