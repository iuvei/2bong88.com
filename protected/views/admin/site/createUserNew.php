...
<body>
    <form action='' method="post">
        <div class="minWidthCustomer">
            ...
            <div class="pt7">
                <div class="btnLeft">
                    <button data-bind='click: saveCustomer' accountpermisssion="[B]" id="btnSubmit" class="btnMain">Thêm</button>
                </div>
            </div>
            <div class="customerInfo">
                <div class="headerTab">Thông tin Chung</div>
                <div class="clearBlock">
                    <div class="customerInfoBlock1">Tài khoản</div>
                    <div class="customerInfoBlock2"><b><span data-bind="text: customer.userName"></span></b>
                        <select id="selectedOne" name="selectedOne"></select>
                        <select id="selectedTwo" name="selectedTwo"></select>
                        <select id="selectedThree" name="selectedThree"></select><span id="msgIcon">&nbsp;&nbsp;&nbsp;</span></div>
                    <div class="customerInfoBlock3">Mật Khẩu</div>
                    <div class="customerInfoBlock4" id="divPassword" title="Mật khẩu phải gồm ít nhất 8 ký tự, không có khoảng trắng và phải có ít nhất 3 ký tự sau đây:
...
Lưu ý : Mật khẩu có phân biệt chữ hoa và chữ thường.">
                        <div class="float_l">
                            <input id="password" autocomplete="off" class="textBoxInfo" type="password" data-bind="value: customer.password" onkeyup="return Fanex.Customer.CheckPassword(this, 'spnNewPwdIcon');" maxlength="50" />
                        </div>
            ...
            <div class="pt7">
                <div class="btnLeft">
                    <button data-bind='click: saveCustomer' accountpermisssion="[B]" id="btnSubmitFooter" class="btnMain">Thêm</button>
                </div>
            </div>
        </div>
    </form>
   ...
   <script src='/assets/js/bet/Core.js?20150304' type='text/javascript'></script>
    ...
    <script src='/assets/js/bet/MemberInfo.js?20150330' type='text/javascript'></script>
    <script src='/assets/js/bet/AddNewMember.js?201529032' type='text/javascript'></script>
</body>
