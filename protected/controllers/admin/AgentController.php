...
class AgentController extends AdminController
{
		...
		if(isset($_POST['User']))
		{
			...
			if($admin!=null)
			{
				...
				if($role=="master" || $role=="admin")
				{
					...
					if($admin->Credit<$user->Credit && $admin->role=="agent")
					{
	...
	public function actionlistUser()
	{
		...
		if(Yii::app()->user->getState("typeUser")=="master")
		{
			$criteria->condition = "parentUser = :id AND role = :role";
			$criteria->params = array(":id"=>Yii::app()->user->getId(),":role"=>"agent");
		}
		else
		{
			$criteria->condition = "role = :role";
			$criteria->params = array(":role"=>"agent");
		}
	...
	public function actionresetPass()
	{
		...
		if(isset($_POST['password']))
		{
			...
			if($user!=null)
			{
				...
				if($user->parentUser!=Yii::app()->user->getId() && Yii::app()->user->getState("typeUser")=="master")
				{
